...
export class UsuarioService {
  ...
  postUsuario(nombre: string, email: string, telefono: string, contrasena: string) {
    const url = `${this.urlbase}/usuario/crear?nombre=${encodeURIComponent(nombre)}&email=${encodeURIComponent(email)}&telefono=${encodeURIComponent(telefono)}&contrasena=${encodeURIComponent(contrasena)}`;
  ...
  putUsuario(id: number, nombre: string, email: string, telefono: string, contrasena: string) {
    const url = `${this.urlbase}/usuario/actualizar?id=${id}&nombre=${encodeURIComponent(nombre)}&email=${encodeURIComponent(email)}&telefono=${encodeURIComponent(telefono)}&contrasena=${encodeURIComponent(contrasena)}`;
